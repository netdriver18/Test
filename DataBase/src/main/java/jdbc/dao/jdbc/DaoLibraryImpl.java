...
public class DaoLibraryImpl implements DaoLibrary {
    ...
    @Override
    public bookEntity getCargoById(Integer book_id, String name_book, String descriptions_book, Integer count_page_book) throws SQLException {
    ...
    @Override
    public List<bookEntity> getAllCargos() {
